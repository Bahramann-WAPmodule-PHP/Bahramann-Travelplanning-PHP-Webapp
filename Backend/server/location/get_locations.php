...
try {
    ...
    $sql = "SELECT location_id, location_name, total_rating, number_of_ratings, description, image_url, hotel_id, vehicle_type FROM location ORDER BY location_id DESC";
